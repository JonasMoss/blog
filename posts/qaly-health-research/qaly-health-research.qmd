...
bibliography: qaly-health-research.bib
---
...
3.  Most examples I've seen in health economics, environmental economics, and marketing are only tangentially related to effective altruism. (I don't claim they don't exist -- there's probably many studies in health economics relevant to EA). But the topics of cognitive burden, experimental design, and experience of researchers when preparing experiments is relevant for anyone who's involved with value estimation. It would probably be good to have at least a medium effort report on these topics. (For context, I consider this post to be low effort.) The literature probably contains a good deal of valuable insights for those sufficiently able and motivated to trudge through it. I would highly appreciate a well-written report on the relevant empirical and social science-theoretical findings here.
